...
let kmPercorrere = parseFloat(prompt('Inserire il numero di km che si vogliono percorrere'));
...
// let prezzoBigliettoMinorenne = (prezzoBiglietto * (1 - (scontoMinorenne / 100)).toFixed(2);
...
if (etaPasseggero < 18) {
    document.writeln("Il prezzo del biglietto è: ", prezzoBigliettoMinorenne + " €");
} else if (etaPasseggero > 65) {
    document.writeln("Il prezzo del biglietto è: ", prezzoBigliettoOver + " €");
} else {
    document.writeln("Il prezzo del biglietto è: ", prezzoBiglietto + " €");
}   
